...
First, I iterated through every commit in the repo, opened the `index.html` page using [Selenium](https://www.selenium.dev/), took a screenshot, and saved it as a PNG. I had to wait three seconds between page loads because my website has a few animations.
...
<figure style="text-align: center">
	<iframe style="max-width: 600px; max-height: 435px; width: 90vw; height: 65.25vw;" max-height="435" width="90vw" height="65.25vw" src="https://www.youtube.com/embed/UfWZ-PzZUGU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
